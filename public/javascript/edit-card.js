...
async function cardEditHandler(event) {
    event.preventDefault();

    const name = document.querySelector('input[name="card-name"]').value.trim();
...
document.querySelector('.edit-card-form').addEventListener('submit', cardEditHandler);